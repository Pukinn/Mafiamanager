...
public class Detective {
	...
	public void night(){
		if (Keys.detective > 0){
			OutputToReferee.command(Messages.getString("detectivesAwake"));
			
			if (Keys.round == 1){
				OutputToReferee.note(Messages.getString("whosDetective"));
			...
			OutputToReferee.command(Messages.getString("askFor"));
			OutputToReferee.note(Messages.getString("type"));
